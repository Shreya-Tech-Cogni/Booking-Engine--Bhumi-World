...
namespace bramhacorp
{
    public partial class sales : System.Web.UI.Page
    {
        ...
        {
            //string strkf1 = encryptdecrypt.Decrypt("MHlJTVpkQ2drd1pVQ012TWhhUVNRZz09");
            //string strkf2 = encryptdecrypt.Encrypt("executive2@avnir.io");
            //string strkf3 = encryptdecrypt.Encrypt("executive3@avnir.io");
            //string strkf4 = encryptdecrypt.Encrypt("executive4@avnir.io");
            //string strkf5 = encryptdecrypt.Encrypt("executive5@avnir.io");
            //string strkf6 = encryptdecrypt.Encrypt("executive6@avnir.io");
            //string strkf7 = encryptdecrypt.Encrypt("executive7@avnir.io");
            //string strkf8 = encryptdecrypt.Encrypt("executive8@avnir.io");
            //string strkf9 = encryptdecrypt.Encrypt("executive9@avnir.io");
            //string strkf10 = encryptdecrypt.Encrypt("executive10@avnir.io");
            //string strkf11 = encryptdecrypt.Encrypt("executive11@avnir.io");
            //string strkf13 = encryptdecrypt.Encrypt("executive12@avnir.io");
            //string strkf134 = encryptdecrypt.Encrypt("avnir@123"); 
            Session.Clear();
            Session.RemoveAll();
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("select  id,uid,name as name from CustomerMaster   where isaccountverify='1' and password=@password and  mobileno=@mobileno ", con);
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        if (Request.Cookies["_ga"] != null)
                        {
                            ...
                            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "bodydfun1", " ga('send', 'event', { eventCategory: 'Authentication', eventAction: 'Login', eventLabel: '" + dt2.Rows[0]["uid"].ToString() + "'}); ga('set', 'userId', '" + dt2.Rows[0]["uid"].ToString() + "'); ga('set', 'dimension2','" + dt2.Rows[0]["uid"].ToString() + "'); ga('set', 'dimension1','" + strcookies + "');", true);
                        }
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (eid != "" && eid != null)
                            {
                                ...
                                if (dt1.Rows.Count > 0)
                                {
                                    ...
                                    weblink = "https://engage.bhumi.in/BoulevardTowers/AdminLogin";
                                }
                                else
                                {
                        ...
                        //                        String singleApiParam
                        //= "feedid=381864&text=Name: " + cname + " Mobile No: " + cmobileno + " , Just logged on Boulevard Towers&to=" + emobileno + "&username=8007040207&password=Bramha@12345";

                        //                        String singMsgApiUrl = "http://bulkpush.mytoday.com/BulkSms/SingleMsgApi";
                        ...
                        //                        {
                        //                            System.Console.WriteLine("Got Web Exception:" + ex);
                        //                        }
                        //                        finally
                        //                        {
                        //                            if (os != null)
                        ...
                        //                            }
                        //                        }
                        //HttpWebRequest myReq1 = (HttpWebRequest)WebRequest.Create("http://msg.galaxydev.in/api/push.json?apikey=5e995c86904d7&route=transactional&sender=ORACRA&mobileno=" + emobileno + "&text=Name: " + cname + " Mobile No: " + cmobileno + " , Just logged on Boulevard Towers");
                        ...
                        string execnameone = Request.QueryString["exec"];
                        Response.Redirect(execnameone + ".aspx");
        ...
        protected void Registerotp_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtpass.Text != "" && txtcmpass.Text != "" && mko == 0)
                {
                    if (txtemailid.Text != "" && txtmob.Text != "")
                    {
                        SqlCommand cmd = new SqlCommand("select  uid, name as name,id from CustomerMaster   where emailID=@emailID and mobileno=@mobileno ", con);
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            Session["projectid"] = "5";
                            Session["stringuid"] = dt2.Rows[0]["id"].ToString();
                            Session["loginreg"] = "Registration";
                            if (Request.Cookies["_ga"] != null)
                            {
                                string strcookies = Request.Cookies["_ga"].Value.ToString().Remove(0, 6);
                                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "bodydfun1", " ga('send', 'event', { eventCategory: 'Authentication', eventAction: 'Register', eventLabel: '" + dt2.Rows[0]["uid"].ToString() + "'}); ga('set', 'userId', '" + dt2.Rows[0]["uid"].ToString() + "'); ga('set', 'dimension2','" + dt2.Rows[0]["uid"].ToString() + "'); ga('set', 'dimension1','" + strcookies + "');", true);
                            }
                            ...
                            //{
                            //    HttpWebRequest myReq1 = (HttpWebRequest)WebRequest.Create("http://msg.galaxydev.in/api/push.json?apikey=5e995c86904d7&route=transactional&sender=ORACRA&mobileno=" + emobileno + "&text=Name: " + cname + " Mobile No: " + cmobileno + " , Just registered on Bhumi Towers");
                            //    HttpWebResponse myResp1 = (HttpWebResponse)myReq1.GetResponse();
                            //    System.IO.StreamReader respStreamReader1 = new System.IO.StreamReader(myResp1.GetResponseStream());
                            //    string responseString1 = respStreamReader1.ReadToEnd();
                            //    respStreamReader1.Close();
        ...
        //        HttpWebRequest myReq1 = (HttpWebRequest)WebRequest.Create("http://msg.galaxydev.in/api/push.json?apikey=5e995c86904d7&route=transactional&sender=ORACRA&mobileno=" + txtmob.Text.Trim() + "&text=%20Dear%20Customer,%0a%0a" + s1 + "%20is%20your%20one%20time%20password%20(OTP).%20Please%20enter%20the%20OTP%20to%20complete%20your%20registration%0a%0aThank%20you%0aTeam%20BramhaCorp");
        //        HttpWebResponse myResp1 = (HttpWebResponse)myReq1.GetResponse();
        //        System.IO.StreamReader respStreamReader1 = new System.IO.StreamReader(myResp1.GetResponseStream());
        //        string responseString1 = respStreamReader1.ReadToEnd();
        //        respStreamReader1.Close();
                ...
                if (txtname.Text.Trim() != "" && txtmob.Text != "" && txtemailid.Text != "" && txtmob.Text.Length == 10)
                {
                    try
                    {
                            ...
                            if (txtmob.Text != "")
                            {
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        ///// otp mail
                                        //MailMessage msg = new MailMessage("bhumiworld2021@gmail.com", txtemailid.Text);
                                        //msg.Subject = "Bhumi World Register OTP";
                                        //Session["otp"] = s1;
                                        ...
                                        //nc.UserName = "bhumiworld2021@gmail.com";
                                        //nc.Password = "bhumi@2021";
                        ...
                        if (intemail == 0 && intmobileno == 0)
                        {
                            ...
                            //    {
                            float hno = 0;
                            SqlCommand cmd = new SqlCommand("Insert into CustomerMaster(uid, entrydate,name, mobileno, emailid, isactive,isaccountverify,isotpsend,lastotpverifeddate)values(@uid,@entrydate,@name,@mobileno,@emailid,@isactive,@isaccountverify,@isotpsend,@lastotpverifeddate)", con);
        ...
        protected void btnforgetReg_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtforpass.Text != "" && txtforcmpass.Text != "")
                {
                    if (txtformob.Text != "")
                    {
                ...
                try
                {
                    ...
                    if (txtformob.Text != "")
                    {
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            //                            cmd12.ExecuteNonQuery();
                            ////                            String singleApiParam
                            ////= "feedid=381864&text=%20Dear%20Customer,%0a%0a" + s1 + "%20is%20your%20one%20time%20password%20(OTP).%20Please%20enter%20the%20OTP%20to%20complete%20your%20registration%0a%0aThank%20you%0aTeam%20BramhaCorp&to=" + txtformob.Text.Trim() + "&username=8007040207&password=Bramha@12345";
                            ...
                            ////                                }
                            ////                            }
                            //                            //HttpWebRequest myReq1 = (HttpWebRequest)WebRequest.Create("http://msg.galaxydev.in/api/push.json?apikey=5e995c86904d7&route=transactional&sender=ORACRA&mobileno=" + txtformob.Text.Trim() + "&text=Your OTP for booking is " + s1 + "");
                            //                            //HttpWebResponse myResp1 = (HttpWebResponse)myReq1.GetResponse();
                            //                            //System.IO.StreamReader respStreamReader1 = new System.IO.StreamReader(myResp1.GetResponseStream());
                            //                            //string responseString1 = respStreamReader1.ReadToEnd();
                            //                            //respStreamReader1.Close();
