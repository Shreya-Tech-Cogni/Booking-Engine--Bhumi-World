<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" Inherits="bramhacorp.info" %>
                        ...
                        <div class="fontweight600 fontsize13 displayinline letterspacing0 headingcolor  bgfontcolor" >
                         <%= Session["unitdetails"].ToString() %><div class="letterspacing1 fontsize10 headingsubcolor fontweight400  bgfontcolor" >
                            ...
                            <asp:Panel ID="pnlstep2" Visible="false" runat="server">
                                <div class="displayinline marginleft5" >
                                    <asp:LinkButton ID="divstep2a" runat="server" class="borderleft lineheight20 displayinline step101 bgcolor"
                                        Style="text-decoration: none;" >
...
Add New
                            ...
                            <asp:Panel ID="pnldataform" Visible="false" runat="server">
                               <form method="post" name="customerData"s>
	...
	<tr>
		<td>TID	:</td><td><input type="text" name="tid" id="tid" readonly /></td>
         ...
         <tr>
            <td>Merchant Id</td>
            <td><input type="text" name="merchant_id" id="merchant_id" value="268320"/></td>
         </tr>
         <tr>
            <td>Order Id</td>
         ...
         <tr>
            <td>Redirect URL</td>
            <td><input type="text" name="redirect_url" value="https://bhumiworldvr.cognilements.com/payment/thanks.aspx"/></td>
         </tr>
	     <tr>
            <td>Cancel URL</td>
            <td><input type="text" name="cancel_url" value="https://bhumiworldvr.cognilements.com/payment/error.aspx"/></td>
         </tr>
         <tr>
