...
namespace bramhacorp
{
    public class encryptdecrypt
    {
        ...
        public static DateTime indiandate()
        {
        ...
        public static string Encryptlist(string clearText)
        {
            string EncryptionKey = "4A93EFC1136E2BBF1742EDB8CAFE2";
            byte[] clearBytes = Encoding.UTF8.GetBytes(clearText);
            byte[] clearBytes1;
            using (Aes encryptor = Aes.Create())
            {
        ...
        public static string Decryptlist(string cipherText)
        {
            string EncryptionKey = "4A93EFC1136E2BBF1742EDB8CAFE2";
