...
{
    public partial class inventorytemp : System.Web.UI.Page
    {
        ...
        protected void ddunitvalue_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(ddunitvalue.Items.Count > 0 && ddunit.SelectedValue=="0")
            {
                Session["svgopenpanel"] = "pnlboth";
                Session["unitcount"] = ddunitvalue.SelectedValue;
                //unitcount1(sender,e);
                // displayrecords1();
                lblmsg.Visible = false;
            }
          else  if (ddunitvalue.Items.Count > 0)
            {
                Session["unitcount"] = ddunitvalue.SelectedValue;
                //unitcount1(sender,e);
                // displayrecords1();
        ...
        protected void displayfilter()
        {
            try
            {
                ...
                string svgpanel = Session["svgopenpanel"].ToString();
                    ...
                    else
                    {
                        ...
                        if (statusidvalue == "1")
                        {
                            ...
                            if (valuecount == countone)
                            {
                                ...
                                headinggreynext.Attributes["style"] = "margin-left: 183px; color: #808080d9 !important";
        ...
        protected void btnpaymentredirect_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkterms.Checked)
                {
                    ...
                    timerbooking.Enabled = true;
                    //Response.Redirect("dataFrom.htm", false);
        ...
        protected void btnPrevious_Clicked(object sender, EventArgs e)
        {
            ...
            var control = FindControl(svg);
            control.Visible = false;
            string svgopen = Session["svgopenpanel"].ToString();
