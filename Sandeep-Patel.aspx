<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sandeep-Patel.aspx.cs" Inherits="bramhacorp.Sandeep_Patel" %>
...
<head>
    ...
    <link rel="preload" href="locale/en.txt?v=1620836221494" as="fetch" crossorigin="anonymous"/>
	<link rel="preload" href="script.js?v=1620836221494" as="script"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/r/3/0_0.jpg?v=1620836221494" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/l/3/0_0.jpg?v=1620836221494" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/u/3/0_0.jpg?v=1620836221494" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/d/3/0_0.jpg?v=1620836221494" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/f/3/0_0.jpg?v=1620836221494" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/b/3/0_0.jpg?v=1620836221494" as="image"/>
	<script src="https://remote.3dvista.com/lib/tdvremote.js?v=1620836221494" type="text/javascript"></script>
    ...
    <script src="lib/tdvplayer.js?v=1620836221494"></script>
    <script src="script.js?v=1620836221494"></script>
    <script type="text/javascript">
        var tour;
        var devicesUrl = { "general": "script_general.js?v=1620836221494", "mobile": { "landscape": "script_general.js?v=1620836221494", "portrait": "script_mobile.js?v=1620836221494" } };
        ...
        function loadTour() {
            ...
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'lib/WebVRPolyfill.js?v=1620836221494');
            settings.set(TDV.PlayerSettings.HLS_URL, 'lib/Hls.js?v=1620836221494');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1620836221494');
        ...
        function onVirtualTourInit() {
            ...
            TDV.Remote.start(tour.player, "vskywwr2irhl");
    ...
    <link rel="stylesheet" href="fonts.css?v=1620836221494">
            ...
            $(window).load(function () {
                $('#preloader').fadeOut(500, function () {
                    ...
                    var interval33 = setInterval(function () {
                        if ($("#86").length) {
                            if (document.getElementsByTagName("iframe")[0].src == "https://bhumiworldvr.cognilements.com/login.aspx?v=1617202466353") {

                                var newsrc = "inventorytemp.aspx?uid=" + '<%= Session["stringuid"] %>';
                                $('#86 iframe').attr("src", newsrc);
                            }
                        }
                    ...
                    //    if ($("#60").length) {
                    //        if (document.getElementsByTagName("iframe")[0].src == "https://bhumiworldvr.cognilements.com/map.aspx?v=1603096163932") {
