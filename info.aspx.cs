    ...
    public partial class info : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
       {
        ...
        protected void btnsubmit_Clicked(object sender, EventArgs e)
        {
            ...
            string orderid = Session["oid"].ToString();
            //timerbooking.Enabled = true;
            ...
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow", "var Mleft = (screen.width/2)-(760/2);var Mtop = (screen.height/2)-(700/2);window.open( 'requesthandler.aspx?BillingName=" + Bname + "&orderid=" + orderid + "&Address=" + txtbuilding.Text + ',' + txtarea.Text + "&city=" + txtcity.Text + "&email=" + Bemail + "&phone=" + Bphone + "&state=" + txtstate.Text + "&zip=" + txtpincode.Text + "', null, 'height=700,width=760,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );", true);
        }
                ...
                if (Session["stepid"] != null)
                {
                    ...
                    if (dt24kh.Rows.Count > 0)
                    {
                        if (dt24kh.Rows[0]["isbookingdone"].ToString() == "1")
                        {
                            ...
                            lblpaymentmsg.Text = "You have successfully blocked your Unit in The Bhumi project. Our team will get in touch with you shortly.";
