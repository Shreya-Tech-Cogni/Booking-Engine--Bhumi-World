<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="data.aspx.cs" Inherits="bramhacorp.data" %>
...
<body>
        ...
        <form method="post" name="customerData" action="request.aspx">
	...
	<tr>
	    ...
	    <tr>
         ...
         <tr>
          	<td></td>
			<td>
         <td><input type="submit" value="Checkout" /></td></td>
         </tr>
    </table>
    </form>
