<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hardik-Gala.aspx.cs" Inherits="bramhacorp.Hardik_Gala" %>
...
<head>
    ...
    <link rel="preload" href="locale/en.txt?v=1620837697373" as="fetch" crossorigin="anonymous"/>
	<link rel="preload" href="script.js?v=1620837697373" as="script"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/r/3/0_0.jpg?v=1620837697373" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/l/3/0_0.jpg?v=1620837697373" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/u/3/0_0.jpg?v=1620837697373" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/d/3/0_0.jpg?v=1620837697373" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/f/3/0_0.jpg?v=1620837697373" as="image"/>
	<link rel="preload" href="media/panorama_AA943F34_EDC2_D8DD_41D1_528D24091156_0/b/3/0_0.jpg?v=1620837697373" as="image"/>
	<script src="https://remote.3dvista.com/lib/tdvremote.js?v=1620837697373" type="text/javascript"></script>
    ...
    <script src="script.js?v=1620837697373"></script>
    <script type="text/javascript">
        var tour;
        var devicesUrl = { "general": "script_general.js?v=1620837697373", "mobile": { "landscape": "script_general.js?v=1620837697373", "portrait": "script_mobile.js?v=1620837697373" } };
        ...
        function loadTour() {
            ...
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'lib/WebVRPolyfill.js?v=1620837697373');
            settings.set(TDV.PlayerSettings.HLS_URL, 'lib/Hls.js?v=1620837697373');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1620837697373');
        ...
        function onVirtualTourInit() {
            ...
            TDV.Remote.start(tour.player, "0s0oagj29504");
    ...
    <link rel="stylesheet" href="fonts.css?v=1620837697373">
