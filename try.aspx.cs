    ...
    public partial class _try : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["uid"] != null)
                {
                    ...
                    SqlCommand cmd343 = new SqlCommand("select * from customerbooking where customerid=@customerid", con);
                    ...
                    {
                        SqlCommand cmd3422 = new SqlCommand("select * from customersteps where customerid=@customerid", con);
                        cmd3422.Parameters.AddWithValue("@customerid", Session["customerid"].ToString());
                        SqlDataAdapter da3433 = new SqlDataAdapter(cmd3422);
                        DataTable dt3433 = new DataTable();
                        da3433.Fill(dt3433);
                        if (dt3433.Rows[0]["orderid"].ToString() != null)
                        {
                            SqlCommand cmd342 = new SqlCommand("update customerbooking set orderid=@orderid where customerid=@customerid", con);
                            cmd342.Parameters.AddWithValue("@customerid", Session["customerid"].ToString());
                            cmd342.Parameters.AddWithValue("@orderid", dt3433.Rows[0]["orderid"].ToString());
                            cmd342.ExecuteNonQuery();

                        }
                        else
                        {
                            SqlCommand cmd3421 = new SqlCommand("update customerbooking set unitdeatails=null where customerid=@customerid", con);
                            cmd3421.Parameters.AddWithValue("@customerid", Session["customerid"].ToString());
                            cmd3421.ExecuteNonQuery();
                        }
                    ...
                    if (Session["customerid"].ToString() != "<%= stringuid %>" && Session["customerid"].ToString() != "")
                    {
                        ...
                        try
                        {
                            ...
                            if (dt2xb.Rows.Count > 0)
                            {
                                ...
                                string billingname = dt2xb.Rows[0]["name"].ToString();
                                Session["billingname"] = billingname;

                                string billingemail = dt2xb.Rows[0]["emailid"].ToString();
                                Session["billingemail"] = billingemail;

                                string billingphone = dt2xb.Rows[0]["mobileno"].ToString();
                                Session["billingphone"] = billingphone;
        ...
        protected void ddtower_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddtower.Items.Count > 0)
            {
                ...
                //ddtower.Items.Clear();
                string valuetower = ddtower.SelectedValue;
                //displayrecords(ddtower.SelectedValue);
                displayfilter();
                // displaysvg();
        ...
        protected void ddunit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddunit.Items.Count > 0)
            {
                ...
                ddunitvalue.Items.Clear();
                ddunitvalue.Items.Insert(0, new ListItem("4", "4"));
                ddunitvalue.Items.Insert(0, new ListItem("3", "3"));
                ddunitvalue.Items.Insert(0, new ListItem("2", "2"));
                ddunitvalue.Items.Insert(0, new ListItem("1", "1"));
                ddunitvalue.Items.Insert(0, new ListItem("No. of unit", "0"));
        ...
        protected void displayfilter()
        {
            try
            {
                ...
                string svgpanel = Session["svg"].ToString();

                //char[] MyChar = { 'p', 'n', 'l' };
                //string NewString = svgpanel.TrimStart(MyChar);
                //string updatesvg = "up" + NewString;


                Panel pan = (Panel)FindControl(svgpanel);


                string searchStr = "LinkButton";
                string cID = null;
                string cmdarg = null;
                string pathid = null;
                string cmdname = null;
                // Panel svg = ((System.Web.UI.WebControls.Panel)pan);
                for (int j = 0; j < pan.Controls.Count; j++)
                {
                    string cID1 = null;
                    string pathid1 = null;
                    Control current1 = pan.Controls[j];
                    if ((current1.ID != null))
                    {
                        cID1 = current1.ID.ToString();
                        pathid1 = ((System.Web.UI.WebControls.LinkButton)current1).Text;
                        if (cID1.Contains(searchStr))
                        {
                            if (pathid1.Contains("cls-disable"))
                            {
                                ((System.Web.UI.WebControls.LinkButton)current1).Text = pathid1.Replace("cls-disable", "cls-2 myclass");
                                ((System.Web.UI.WebControls.LinkButton)current1).Attributes.Add("OnClick", "");
                                ((System.Web.UI.WebControls.LinkButton)current1).Attributes.CssStyle[HtmlTextWriterStyle.Cursor] = "pointer;";
                                if (((System.Web.UI.WebControls.LinkButton)current1).Enabled == false)
                                {
                                    ((System.Web.UI.WebControls.LinkButton)current1).Enabled = true;
                                }
                            }
                            else if (pathid1.Contains("cls-myclass2"))
                            {
                                ((System.Web.UI.WebControls.LinkButton)current1).Text = pathid1.Replace("cls-myclass2", "cls-2 myclass");
                            }
                ...
                int i = 0;
                while (i < pan.Controls.Count)
                {
                    Control current = pan.Controls[i];
                    if ((current.ID != null))
                    {
                        cID = current.ID.ToString();

                        if (cID.Contains(searchStr))
                        {
                            pathid = ((System.Web.UI.WebControls.LinkButton)current).Text;
                            cmdname = ((System.Web.UI.WebControls.LinkButton)current).CommandName.ToString();
                            cmdarg = ((System.Web.UI.WebControls.LinkButton)current).CommandArgument.ToString();
                            // string output = "";
                            // string output1 = "";
                            string output2 = "";
                            string output3 = "";
                            string towername = ddtower.SelectedItem.Text;
                            if (towername == cmdarg)
                            {
                                if (pathid.Contains("cls-disable"))
                                {
                                    output3 = pathid.Replace("cls-disable", "cls-myclass2");
                                }
                                else if (pathid.Contains("cls-myclass2"))
                                {
                                    output3 = pathid.Replace("cls-myclass2", "cls-myclass2");
                                }
                                else if (pathid.Contains("cls-2 myclass"))
                                {
                                    output3 = pathid.Replace("cls-2 myclass", "cls-myclass2");
                                }
                                //output3 = pathid.Replace("cls-2 myclass", "cls-myclass2");
                                ((System.Web.UI.WebControls.LinkButton)current).Text = output3;
                            ...
                            else
                            {
                                if (pathid.Contains("cls-disable"))
                                {
                                    output2 = pathid.Replace("cls-disable", "cls-disable");
                                }
                                else if (pathid.Contains("cls - myclass2"))
                                {
                                    output2 = pathid.Replace("cls - myclass2", "cls-disable");
                                }
                                else if (pathid.Contains("cls-2 myclass"))
                                {
                                    output2 = pathid.Replace("cls-2 myclass", "cls-disable");
                                }

                                ((System.Web.UI.WebControls.LinkButton)current).Text = output2;
                                ((System.Web.UI.WebControls.LinkButton)current).Attributes.Remove("OnClick");
                                ((System.Web.UI.WebControls.LinkButton)current).Attributes.CssStyle[HtmlTextWriterStyle.Cursor] = "default";
                                ((System.Web.UI.WebControls.LinkButton)current).Enabled = false;
                            }
                        }
                    }
        ...
        public void FindCtrl(Control control)
        {
        }

        protected void displayblock(String towerid)
        {
            //LinkButton lnkconfigselect = new LinkButton();
            //LinkButton lnkcardclick = (LinkButton)sender;
            //lnkconfigselect.CommandArgument = lnkcardclick.CommandArgument;
            // string[] strtowerid = lnkconfigselect.CommandArgument.ToString().Split('_');
            try
            {
                if (con.State != ConnectionState.Open)
                {
                ...
                if (!string.IsNullOrEmpty(towerid))
                {
                    ...
                    Session["toweridvalue"] = towerid;
                    SqlCommand cmd2x = new SqlCommand("select distinct f.id,f.printname as floorname from propertylistconfig as c left outer join floormaster as f on f.id=c.floorid where  c.towerid=@towerid order by f.id desc", con);
                ...
                //Panel myPanel = cont.FindControl(pnlA5);
            }
            catch (Exception ex)
            {
        ...
        protected void displayrecords1(String towerid)
        {
            try
            {
                ...
                {
                    SqlCommand cmd2x = new SqlCommand("select distinct pt.id, towername from propertylisttower as pt left outer join propertylistconfig as pc on pt.id = pc.towerid where pc.unittype = 1 and propid=@propertyid and pt.unittypeno=1", con);
                    cmd2x.Parameters.AddWithValue("@propertyid", Session["projectid"].ToString());
                    SqlDataAdapter da2x = new SqlDataAdapter(cmd2x);
                    DataTable dt2x = new DataTable();
                    da2x.Fill(dt2x);
                    ...
                    if (ddtower.Items.Count > 0)
                    {
                        ...
                        pnlsShed.Visible = true;
                        pnlrRcc.Visible = false;
                        pnlboth.Visible = false;
                        Session["svg"] = "pnlsShed";
                ...
                {
                    SqlCommand cmd2x = new SqlCommand("select distinct pt.id, towername from propertylisttower as pt left outer join propertylistconfig as pc on pt.id = pc.towerid where pc.unittype = 2 and propid=@propertyid and pt.unittypeno=2", con);
                    cmd2x.Parameters.AddWithValue("@propertyid", Session["projectid"].ToString());
                    SqlDataAdapter da2x = new SqlDataAdapter(cmd2x);
                    DataTable dt2x = new DataTable();
                    da2x.Fill(dt2x);
                    ...
                    {
                        displayrecords(ddtower.SelectedValue);
                        pnlsShed.Visible = false;
                        pnlrRcc.Visible = true;
                        pnlboth.Visible = false;
                        Session["svg"] = "pnlrRcc";
                    }

                }
                else if (ddunit.SelectedValue == "0")
                {
        ...
        protected void rptfloor_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    //LinkButton lnkcardclick = (LinkButton)sender;
                    //lnkconfigselect.CommandArgument = lnkcardclick.CommandArgument;
                    //string[] strtowerid = lnkcardclick.CommandArgument.ToString().Split('_');
                    //string towerid = strtowerid[0];

                    Label lblid = (Label)e.Item.FindControl("lblid");
                    Repeater rptunit = (Repeater)e.Item.FindControl("rptunit");
                    SqlCommand cmd424s = new SqlCommand("select  pc.id as unitid,case when c.colorcode!='' or c.colorcode!=null then c.colorcode else '#b01b2a' end as statuscolor,case when pc.statusid=2 then 'soldback' when pc.statusid=4 then 'soldback'  when pc.statusid=5 then 'soldback' when pc.statusid=3 then 'holdback' else '' end as statusback,pc.priority from  propertylistconfig as pc left outer join propertyconfigmaster as c on c.id=pc.configid where pc.towerid=@towerid and floorid=@floorid order by pc.priority asc", con);

                    cmd424s.Parameters.AddWithValue("@towerid", Session["toweridvalue"]);
        ...
        protected void rptcostsheetfirst_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    if (ddtower.Items.Count > 0)
                    {
                        ...
                        Label lblid = (Label)e.Item.FindControl("lblid");
                        Repeater rptcostsheet = (Repeater)e.Item.FindControl("rptcostsheet");

                        //var rptitem = (RepeaterItem)lnkrightbooks.NamingContainer;
                        //Label lblpopunittype = (Label)rptitem.FindControl("lblpopunittype");

                        Label lblbuiltup = (Label)e.Item.FindControl("lblbuiltup");
                        Label lblcarpetarea = (Label)e.Item.FindControl("lblcarpetarea");
                        Label lblrate = (Label)e.Item.FindControl("lblrate");

                        Label lbldevelopment = (Label)e.Item.FindControl("lbldevelopment");
                        Label lblregistartion = (Label)e.Item.FindControl("lblregistartion");
                        Label lbllegalfess = (Label)e.Item.FindControl("lbllegalfess");

                        Label lblcost = (Label)e.Item.FindControl("lblcost");
                        Label lblnetcost = (Label)e.Item.FindControl("lblnetcost");
                        Label lblstampduty = (Label)e.Item.FindControl("lblstampduty");
                        Label lblgst = (Label)e.Item.FindControl("lblgst");
                        Label lblpayreg = (Label)e.Item.FindControl("lblpayreg");
                        Label lblmaintainance = (Label)e.Item.FindControl("lblmaintainance");
                        ...
                        //Label lblbuiltup = (Label)rptitem.FindControl("lblbuiltup");
                        //Label lblcarpetarea = (Label)rptitem.FindControl("lblcarpetarea");
                        //Label lblrate = (Label)rptitem.FindControl("lblrate");

                        //Label lbldevelopment = (Label)rptitem.FindControl("lbldevelopment");
                        //Label lblregistartion = (Label)rptitem.FindControl("lblregistartion");
                        //Label lbllegalfess = (Label)rptitem.FindControl("lbllegalfess");

                        //Label lblcost = (Label)rptitem.FindControl("lblcost");
                        //Label lblnetcost = (Label)rptitem.FindControl("lblnetcost");
                        //Label lblstampduty = (Label)rptitem.FindControl("lblstampduty");
                        //Label lblgst = (Label)rptitem.FindControl("lblgst");
                        //Label lblpayreg = (Label)rptitem.FindControl("lblpayreg");
                        //Label lblmaintainance = (Label)rptitem.FindControl("lblmaintainance");

                        //Label lbltotalvalue = (Label)rptitem.FindControl("lbltotalvalue");
                        //Label lblunit = (Label)rptitem.FindControl("lblunit");
                        ...
                        DataTable dt24s = new DataTable();
                        da24s.Fill(dt24s);
                        rptcostsheet.DataSource = dt24s;
                        rptcostsheet.DataBind();
        ...
        protected void btnstepunit_Clicked(object sender, EventArgs e)
        {
            if (Session["paymenttransaction"].ToString() != "1")
            {
                pnlunit.Visible = true;
                ...
                pnlstep5.Visible = false;
                pnlconfirmdoc.Visible = false;
                pnlheadingtwo.Visible = false;
                pnlfloorplan2.Visible = false;
                //pnlheading.Visible = true;
                //ddunit.Visible = true;
                //ddtower.Visible = true;
                //ddunitvalue.Visible = true;
                //pnlboth.Visible = true;
                pnlunitdetails.Visible = false;

                ddunitvalue.Visible = false;
                ddtower.Visible = false;
                ddunit.Visible = false;
                ddunitvalue.Visible = false;
                btnPrevious.Visible = false;
                pnlfloorplan2.Visible = true;
                ...
                string svg = Session["visiblesvg"].ToString();
                var control = FindControl(svg);
        ...
        protected void btnunitbottom_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddunitvalue.SelectedValue != "0")
                {
                    ...
                    Label lblbuildingtype = (Label)rptitem.FindControl("lblbuildingtype");
                    Label lblunit = (Label)rptitem.FindControl("lblunit");

                    //Label lblrightunit = (Label)rptitem.FindControl("lblrightunit");
                    ...
                    da341.Fill(dt341);
                    dt24s.Rows[0]["statusid"].ToString();
                    string statusidvalue = dt24s.Rows[0]["statusid"].ToString();
                    if (dt341.Rows.Count == 0 && statusidvalue == "1")
                    {
                        ...
                        lnkbtn.Attributes["style"] = "border:none;background : #b01b2a  !important ";
                    ...
                    else
                    {
                            ...
                            else
                            {
                                if (statusidvalue == "1")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        //cmd233.Parameters.AddWithValue("@customerid", Session["customerid"].ToString());
                                        //cmd233.ExecuteNonQuery();
                                        //SqlCommand cmd23411 = new SqlCommand("select * from customerbooking where customerid=@customerid", con);

                                        //cmd23411.Parameters.AddWithValue("@customerid", Session["customerid"].ToString());
                                        //SqlDataAdapter da23411 = new SqlDataAdapter(cmd23411);
                                        //DataTable dt23411 = new DataTable();
                                        //da341.Fill(dt23411);

                                        //string[] unitid2 = dt23411.Rows[0]["unitdeatails"].ToString().Split(',');
                                        // Session["unitid2"] = unitid2.Length;
                                        //string output = unitid2.Substring(unitid2.IndexOf(',') + 1);

                                        //int countone2 = Convert.ToInt32(Session["unitid2"].ToString());
                                        //int valuecount2 = Convert.ToInt32(ddunitvalue.SelectedValue);
                        ...
                        if (statusidvalue == "1")
                        {
                            ...
                            if (valuecount == countone)
                            {
                                ...
                                LinkButton1328.Visible = true;
                                //LinkButton1332.Visible = true;
                                LinkButton1337.Visible = true;
                                headinggreynext.Attributes["style"] = "margin-left: 260px; color: #808080d9 !important";
                            }
                            else
                            {
                                ...
                                //LinkButton15.Visible = false;
                                LinkButton1328.Visible = false;
                                //LinkButton1332.Visible = false;
                                LinkButton1337.Visible = false;
                            }
                        }
                    }
                    ...
                    if (dt24s.Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (ddtower.SelectedValue == "1" || ddtower.SelectedValue == "2")
                            {
                                lblrightconfig.Text = ddtower.SelectedItem.Text;
                            }
                            else
                            {
                                lblrightconfig.Text = Session["svgname"].ToString();
                            }
                        ...
                        //divpopup.Attributes["style"] = "display:block;";
        ...
        protected void btnnextcostsheet_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine(i);
                    //unitid3 = lnkbottombook.CommandArgument;
                    LinkButton lnkbottombook = new LinkButton();
                    lnkbottombook.CommandArgument = i;
        ...
        //protected void displaycostsheet()
        //{
        //    try
        //    {
        //        if (con.State != ConnectionState.Open)
        ...
        //            con.Open();
        //        }
        //        //LinkButton lnkrightbook = new LinkButton();
        ...
        //        {
        //            Console.WriteLine(i);
        //            LinkButton lnkrightbooks = new LinkButton();
        //            lnkrightbooks.CommandArgument = i;

        //            var rptitem = (RepeaterItem)lnkrightbooks.NamingContainer;
        //            //Repeater rptcostsheet = (Repeater)rptitem.FindControl("rptcostsheet");
        ...
        //            DataTable dt24s = new DataTable();
        //            da24s.Fill(dt24s);
        //            rptcostsheetfirst.DataSource = dt24s;
        //            rptcostsheetfirst.DataBind();
        ...
        public class Customer
        {
            ...
            public string pricesqft { get; set; }
            ...
            public string payreg { get; set; }
            public string maintainancecal { get; set; }
            public string maintainance { get; set; }
            public string totalvalue { get; set; }
            public string wallcharges { get; set; }


        }

        protected void unitdeatilsdata()
        {
            SqlCommand cmd2341 = new SqlCommand("select * from customerbooking where customerid=@customerid", con);
            ...
            foreach (string i in unitid3)
            {
                ...
                cmd.Parameters.AddWithValue("@step1date", encryptdecrypt.indiandate());
                cmd.Parameters.AddWithValue("@stepid", Session["stepid"].ToString());
                cmd.Parameters.AddWithValue("@unitid", lnkrightbooks.CommandArgument);
                cmd.Parameters.AddWithValue("@isstep1", 1);
                int k = cmd.ExecuteNonQuery();
                ...
                //rptcostsheet.DataBind();
                string fare = "1234567";
                // float parsed = float.Parse(fare, CultureInfo.InvariantCulture);
                float parsed = float.Parse(fare, CultureInfo.InvariantCulture.NumberFormat);
                CultureInfo hindi = new CultureInfo("hi-IN");



                SqlCommand cmd424s = new SqlCommand("select pc.builduparea as builduparea,pc.configname as configname ,pc.carpetarea as carpetarea, pc.pricesqft as pricesqft,pc.developmentcharges as developmentcharges,pc.regfees as regfees," +
                    "pc.legalfees as legalfees,'' as cost,'' as netcost,'' as stampduty,'' as gst,'' as payreg,'' as maintainance,'' as wallcharges,'' as buildingtype,'' as totalvalue,c.name as config,f.printname as floorname from propertylistconfig as pc left outer join propertyunitmaster as c on c.id = pc.unittype left outer join floormaster as f on f.id = pc.floorid where pc.id=@id", con);
                cmd424s.Parameters.AddWithValue("@id", lnkrightbooks.CommandArgument);
                SqlDataAdapter da24s = new SqlDataAdapter(cmd424s);
                DataTable dt24s = new DataTable();
                da24s.Fill(dt24s);
                ...
                //string carpetarea = "0", pricesqft = "0", netcost="0", builduparea = "0",cost="0", developmentcharges = "0", regfees="0", legalfees = "0";
                double carpetarea = 0.0, pricesqft = 0.0, netcost = 0.0, builduparea = 0.0, cost = 0.0, developmentcharges = 0.0, regfees = 0.0, legalfees = 0.0;
                if (dt24s.Rows.Count > 0)
                {

                    for (int j = 0; j < dt24s.Rows.Count; j++)
                    {
                        string configname = "", buildingtype = "";
                        //lblunit.Text = lblpopunit.Text;
                        carpetarea = float.Parse(dt24s.Rows[0]["carpetarea"].ToString());
                        builduparea = float.Parse(dt24s.Rows[0]["builduparea"].ToString());
                        pricesqft = float.Parse(dt24s.Rows[0]["pricesqft"].ToString());

                        developmentcharges = float.Parse(dt24s.Rows[0]["developmentcharges"].ToString());
                        configname = dt24s.Rows[0]["configname"].ToString();
                        regfees = float.Parse(dt24s.Rows[0]["regfees"].ToString());
                        legalfees = float.Parse(dt24s.Rows[0]["legalfees"].ToString());
                        buildingtype = dt24s.Rows[0]["config"].ToString() + " - " + dt24s.Rows[0]["floorname"].ToString();


                        dt24s.Rows[j]["carpetarea"] = String.Format("{0:n0}", carpetarea);
                        dt24s.Rows[j]["builduparea"] = String.Format("{0:n0}", builduparea);
                        dt24s.Rows[j]["pricesqft"] = String.Format("{0:n0}", pricesqft);
                        dt24s.Rows[j]["developmentcharges"] = String.Format("{0:n0}", developmentcharges);
                        dt24s.Rows[j]["regfees"] = String.Format("{0:n0}", regfees);
                        dt24s.Rows[j]["legalfees"] = String.Format("{0:n0}", legalfees);
                        if (Session["unittype"].ToString() == "1")
                        {
                            string wallcharges = "Rs 300 Per Sqft";
                            //int m = 0;
                            wallcharges = dt24s.Rows[0]["wallcharges"].ToString();
                ...
                if (Session["projectid"].ToString() == "1")
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        double final = 0.0, stampduty = 0.0, gst = 0.0, payreg = 0.0, maintainance = 0.0, totalvalue = 0.0, maintainancecal = 0.0;

                        //carpetarea = float.Parse(dr["carpetarea"].ToString());
                        //pricesqft = float.Parse(dr["pricesqft"].ToString());
                        //builduparea = float.Parse(dr["builduparea"].ToString());
                        cost = carpetarea * builduparea;

                        netcost = pricesqft + cost;
                        stampduty = cost * 6 / 100;
                        gst = (developmentcharges * 18 / 100) + (netcost * 12 / 100);
                        payreg = stampduty + regfees + gst + legalfees;
                        maintainancecal = builduparea * 1.5 * 24;
                        maintainance = maintainancecal + (maintainancecal * 18 / 100);
                        totalvalue = netcost + payreg + maintainance;

                        string p1 = totalvalue.ToString();
                        final = Convert.ToDouble(p1);
                        int v = 0;
                        dt24s.Rows[v]["cost"] = String.Format("{0:n0}", cost);
                        dt24s.Rows[v]["netcost"] = String.Format("{0:n0}", netcost);
                        dt24s.Rows[v]["stampduty"] = String.Format("{0:n0}", stampduty);
                        dt24s.Rows[v]["gst"] = String.Format("{0:n0}", gst);
                        dt24s.Rows[v]["payreg"] = String.Format("{0:n0}", payreg);
                        dt24s.Rows[v]["maintainance"] = String.Format("{0:n0}", maintainance);
                        dt24s.Rows[v]["stampduty"] = String.Format("{0:n0}", stampduty);
                        dt24s.Rows[v]["totalvalue"] = String.Format("{0:n0}", totalvalue);


                        lblapartment.Text = final.ToString();
                        ...
                        {
                            builduparea = dt24s.Rows[0]["builduparea"].ToString(),
                            carpetarea = dt24s.Rows[0]["carpetarea"].ToString(),
                            configname = dt24s.Rows[0]["configname"].ToString(),
                            buildingtype = dt24s.Rows[0]["config"].ToString() + " - " + dt24s.Rows[0]["floorname"].ToString(),
                            pricesqft = dt24s.Rows[0]["pricesqft"].ToString(),

                            developmentcharges = dt24s.Rows[0]["developmentcharges"].ToString(),

                            regfees = dt24s.Rows[0]["regfees"].ToString(),
                            legalfees = dt24s.Rows[0]["legalfees"].ToString(),

                            //cost = dt24s.Rows[0]["cost"].ToString(),
                            netcost = dt24s.Rows[v]["netcost"].ToString(),

                            stampduty = dt24s.Rows[v]["stampduty"].ToString(),
                            gst = dt24s.Rows[v]["gst"].ToString(),
                            payreg = dt24s.Rows[v]["payreg"].ToString(),
                            maintainance = dt24s.Rows[v]["maintainance"].ToString(),
                            totalvalue = dt24s.Rows[v]["totalvalue"].ToString(),
                            cost = dt24s.Rows[v]["cost"].ToString(),
                            wallcharges = dt24s.Rows[0]["wallcharges"].ToString(),
                        });
            ...
            double costtotal = 0;
            foreach (var units in customers)
            {
                double costone = Convert.ToDouble(units.cost);
                costtotal += costone;
            }
        ...
        protected void btnunit_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (string i in unitid3)
                {
                    ...
                    if (dt24s.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt24s.Rows.Count; j++)
                        {
                            ...
                            if (Session["unittype"].ToString() == "1" && Session["unitcount"].ToString() == "1")
                            {
                                string wallcharges = "937500";
                                //int m = 0;
                                wallcharges = dt24s.Rows[0]["wallcharges"].ToString();
                                dt24s.Rows[j]["wallcharges"] = String.Format("{0:n0}", wallcharges);
                            }
                            else if (Session["unittype"].ToString() == "1")
                            {
                                string wallcharges = "-";
                                // int m = 0;
                                wallcharges = dt24s.Rows[0]["wallcharges"].ToString();
                    ...
                    if (Session["projectid"].ToString() == "1")
                    {
                        ...
                        if (dr.HasRows)
                        {
                            ...
                            if (Session["unittype"].ToString() == "1" && Session["unitcount"].ToString() == "1")
                            {
                                wallcharges = 937500;
                                cost = carpetarea * builduparea;
                                netcost = pricesqft + cost + wallcharges;
                                stampduty = cost * 6 / 100;
                                gst = (developmentcharges * 18 / 100) + (netcost * 12 / 100);
                                payreg = stampduty + regfees + gst + legalfees;
                                maintainancecal = builduparea * 1.5 * 24;
                            ...
                            dt24s.Rows[v]["stampduty"] = String.Format("{0:n0}", stampduty);
                            dt24s.Rows[v]["totalvalue"] = String.Format("{0:n0}", totalvalue);
                            dt24s.Rows[v]["wallcharges"] = String.Format("{0:n0}", wallcharges);
                        ...
                        if (Session["unittype"].ToString() == "1")
                        {
                            SqlCommand cmd2x1j = new SqlCommand("select  t.name as terms,'' as wallcharges from paymentscheduleterms as t left outer join propertylist as p on p.id=t.paymentid where p.id=@propertyid and unittype=1", con);
                            cmd2x1j.Parameters.AddWithValue("@propertyid", Session["projectid"].ToString());
                            SqlDataAdapter da2x1j = new SqlDataAdapter(cmd2x1j);
                            DataTable dt2x1j = new DataTable();
                            da2x1j.Fill(dt2x1j);
                            ...
                            string wallcharges = "Rs 300 Per Sqft";
                            int m = 0;
                            dt2x1j.Rows[m]["wallcharges"] = String.Format("{0:n0}", wallcharges);
                        ...
                        {
                            SqlCommand cmd2x1j = new SqlCommand("select  t.name as terms,'' as wallcharges from paymentscheduleterms as t left outer join propertylist as p on p.id=t.paymentid where p.id=@propertyid and unittype=2", con);
                            cmd2x1j.Parameters.AddWithValue("@propertyid", Session["projectid"].ToString());
                            SqlDataAdapter da2x1j = new SqlDataAdapter(cmd2x1j);
                            DataTable dt2x1j = new DataTable();
                            da2x1j.Fill(dt2x1j);
                    ...
                    string unitstotal = "";
                    foreach (var unitlabel in customers)
                    {
                        string unitname = unitlabel.configname;
                        unitstotal = unitstotal + "," + unitname;

                    }
                    lblcunit.Text = unitstotal;
                    lblunitname.Text = lblcunit.Text;
                    lblunitmobile.Text = lblcunit.Text;
                    divright.Attributes["style"] = "display:none;";
                    //LinkButton lnkcardclick = (LinkButton)sender;
                    //Session["unitdetails"] = lblunit.Text;
                    // lblcunit.Text = lblrightconfig.Text + " - " + lblbottomunit.Text;
                    ...
                    step11.Attributes["Style"] = "background-color:#b01b2a; !important;";
                    steptext.Attributes["Style"] = "color:#fff !important;";
                    steptextone.Attributes["Style"] = "color:#fff !important;";
                    step111.Attributes["Style"] = "background-color:#b01b2a; !important;";
                    //steptext111.Attributes["Style"] = "color:#fff !important;";
                    steptext11.Attributes["Style"] = "color:#fff !important;";
                    pnlunit.Visible = false;
                    pnlcostsheet.Visible = true;
                    //timerbooking.Enabled = true; 
                    pnlcostsheetinside.Visible = true;
                ...
                rptcostsheet.DataSource = customers;
                rptcostsheet.DataBind();
                Session["custinfo"] = customers;
            ...
            try
            {
                ...
                if (lblapartment.Text != "")
                {
                    ...
                    foreach (string i in unitid3)
                    {
                        ...
                        //SqlCommand cmd1 = new SqlCommand("update customersteps set unitid=@unitid, isstep1=@isstep1,step1date=@step1date where stepid=@stepid", con);
                        //cmd1.Parameters.AddWithValue("@step1date", encryptdecrypt.indiandate());
                        //cmd1.Parameters.AddWithValue("@stepid", Session["stepid"].ToString());
                        //cmd1.Parameters.AddWithValue("@unitid", lnkrightbooks.CommandArgument);
                        //cmd1.Parameters.AddWithValue("@isstep1", 1);
                        ...
                        if (Session["projectid"].ToString() == "1")
                        {
                            string qry1 = "select a.cgst,a.sgst,lessvalue from propertylist a where a.id=@propid  ";
                            string lessvalue = "0";
                    ...
                    double costtotal = 0, stampdutytotal = 0, registrationtotal = 0, legalfesstotal = 0, developmenttotal = 0, maintainancetotal = 0;
                    double wallchargetotal = 0;
                    foreach (var units in customers)
                    {
                        double costone = Convert.ToDouble(units.cost);
                        costtotal += costone;

                        double stampdutyone = Convert.ToDouble(units.stampduty);
                        stampdutytotal += stampdutyone;

                        double registrationone = Convert.ToDouble(units.regfees);
                        registrationtotal += registrationone;

                        double legalfessone = Convert.ToDouble(units.legalfees);
                        legalfesstotal += legalfessone;

                        double devlopmentone = Convert.ToDouble(units.developmentcharges);
                        developmenttotal += devlopmentone;

                        //double wallchageone = Convert.ToDouble(units.wallcharges);
                        //wallchargetotal += wallchageone;

                        double maintainanceone = Convert.ToDouble(units.maintainance);
                        maintainancetotal += maintainanceone;



                    }
                    Console.WriteLine(costtotal);
                    Console.WriteLine(stampdutytotal);
                    Console.WriteLine(registrationtotal);
                    Console.WriteLine(legalfesstotal);
                    Console.WriteLine(developmenttotal);
                    Console.WriteLine(wallchargetotal);
                    Console.WriteLine(maintainancetotal);
                    ...
                    if (Session["unittype"].ToString() == "1")
                    {
                        ...
                        double one = (costtotal * 25 / 100);
                        lblone.Text = String.Format("{0:n0}", one);
                        double two = (one * 12 / 100);
                        lbltwo.Text = String.Format("{0:n0}", two);

                        double regone = (stampdutytotal + registrationtotal + legalfesstotal);
                        double regtwo = 0.0;
                        lblregone.Text = String.Format("{0:n0}", regone);
                        double plintone = one;
                        lblplintone.Text = String.Format("{0:n0}", one);
                        double plintwo = two;
                        lblplinttwo.Text = String.Format("{0:n0}", two);

                        double arrivalone = (costtotal * 20 / 100);
                        lblArrivalone.Text = String.Format("{0:n0}", arrivalone);
                        double arrivaltwo = (arrivalone * 12 / 100);
                        lblArrivaltwo.Text = String.Format("{0:n0}", arrivaltwo);
                        double pebone = arrivalone;
                        lblpebone.Text = String.Format("{0:n0}", arrivalone);
                        double pebtwo = arrivaltwo;
                        lblpebtwo.Text = String.Format("{0:n0}", arrivaltwo);

                        double possesionone = ((costtotal * 10 / 100) + developmenttotal + maintainancetotal + wallchargetotal);
                        lblpossesionone.Text = String.Format("{0:n0}", possesionone);
                        double possesiontwo = ((costtotal * 10 / 100) + (developmenttotal * 18 / 100));
                        lblpossesiontwo.Text = String.Format("{0:n0}", possesiontwo);
                        double totalone = (one + regone + plintone + arrivalone + pebone + possesionone);
                        lbltotalone.Text = String.Format("{0:n0}", totalone);
                        double totaltwo = (two + regtwo + plintwo + arrivaltwo + pebtwo + possesiontwo);
                        lbltotaltwo.Text = String.Format("{0:n0}", totaltwo);
                    }
                    else if (Session["unittype"].ToString() == "2")
                    {
                        ...
                        double bookrccone = (costtotal * 25 / 100);
                        double bookrcctwo = (bookrccone * 12 / 100);

                        lblbookrccone.Text = String.Format("{0:n0}", bookrccone);
                        lblbookrcctwo.Text = String.Format("{0:n0}", bookrcctwo);

                        double plintrccone = bookrccone;
                        double plintrcctwo = bookrcctwo;
                        lblplintrccone.Text = String.Format("{0:n0}", bookrccone);
                        lblplintrcctwo.Text = String.Format("{0:n0}", bookrcctwo);

                        double regrccone = (stampdutytotal + registrationtotal + legalfesstotal);
                        lblregrccone.Text = String.Format("{0:n0}", regrccone);
                        double regrcctwo = 0.0;
                        double rccsslabone = (costtotal * 15 / 100);
                        lblrccsslabone.Text = String.Format("{0:n0}", rccsslabone);
                        double rccsslabtwo = (rccsslabone * 12 / 100);
                        lblrccsslabtwo.Text = String.Format("{0:n0}", rccsslabtwo);


                        double rccsslabthree = (costtotal * 15 / 100);
                        lblrccsslabthree.Text = String.Format("{0:n0}", rccsslabthree);
                        double rccslabfour = (rccsslabthree * 12 / 100);
                        lblrccslabfour.Text = String.Format("{0:n0}", rccslabfour);

                        double rccsslabfive = (costtotal * 15 / 100);
                        double rccsslabsix = (rccsslabfive * 12 / 100);

                        lblrccsslabfive.Text = String.Format("{0:n0}", rccsslabfive);
                        lblrccsslabsix.Text = String.Format("{0:n0}", rccsslabsix);

                        double rccpossesionone = ((costtotal * 5 / 100) + developmenttotal + maintainancetotal);
                        double rccpossesiontwo = ((costtotal * 5 / 100) + (developmenttotal * 18 / 100));
                        lblrccpossesionone.Text = String.Format("{0:n0}", rccpossesionone);
                        lblrccpossesiontwo.Text = String.Format("{0:n0}", rccpossesiontwo);

                        double rcctotalone = (bookrccone + plintrccone + regrccone + rccsslabone + rccsslabthree + rccpossesionone + rccsslabfive);
                        double rcctotaltwo = (bookrcctwo + plintrcctwo + regrcctwo + rccslabfour + rccpossesiontwo + rccsslabsix + rccsslabtwo);
                        lblrcctotalone.Text = String.Format("{0:n0}", rcctotalone);
                        lblrcctotaltwo.Text = String.Format("{0:n0}", rcctotaltwo);
                ...
                step22.Attributes["Style"] = "background-color:#b01b2a !important;";
                steptext2.Attributes["Style"] = "color:#fff !important;";
                steptexttwo.Attributes["Style"] = "color:#fff !important;";
                step222.Attributes["Style"] = "background-color:#b01b2a !important;";
                //steptext222.Attributes["Style"] = "color:#fff !important;";
                steptext22.Attributes["Style"] = "color:#fff !important;";
                Session["regfees"] = "1,00,000";
                pnlunit.Visible = false;
                pnlcostsheet.Visible = false;
                pnlschedule.Visible = true;
        ...
        protected void btnschedule_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                step33.Attributes["Style"] = "background-color:#b01b2a !important;";
                steptext3.Attributes["Style"] = "color:#fff !important;";
                steptextthree.Attributes["Style"] = "color:#fff !important;";
                step333.Attributes["Style"] = "background-color:#b01b2a !important;";
                // steptext333.Attributes["Style"] = "color:#fff !important;";
                steptext33.Attributes["Style"] = "color:#fff !important;";
                pnlunit.Visible = false;
                pnlcostsheet.Visible = false;
                pnlschedule.Visible = false;
                pnlbookingform.Visible = true;
        ...
        protected void btnpaymentredirect_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkterms.Checked)
                {
                    ...
                    step55.Attributes["Style"] = "background-color:#b01b2a !important;";
                    steptext5.Attributes["Style"] = "color:#fff !important;";
                    steptextfive.Attributes["Style"] = "color:#fff !important;";

                    step555.Attributes["Style"] = "background-color:#b01b2a !important;";
                    //steptext555.Attributes["Style"] = "color:#fff !important;";
                    steptext55.Attributes["Style"] = "color:#fff !important;";
                    //HtmlControl control = FindControl("step55") as HtmlControl;
                    //control.Attributes["class"] = "background-color:#b01b2a !important;";
                    //HtmlControl control1 = FindControl("steptext5") as HtmlControl;
                    //control1.Attributes["class"] = "color:#fff !important;";
                    //HtmlControl control2 = FindControl("steptextfive") as HtmlControl;
                    //control2.Attributes["class"] = "color:#fff !important;";
                    ...
                    pnlbookingform.Visible = false;
                    pnlpay.Visible = true;
                    lblheader.Text = "Thank You for Booking With Us";
                    lblpaymentmsg.Text = "";
                    ...
                    //steptext.Attributes["Style"] = "color:#fff !important;";
                    //steptextone.Attributes["Style"] = "color:#fff !important;";
                    //ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow", "var Mleft = (screen.width/2)-(760/2);var Mtop = (screen.height/2)-(700/2);window.open( 'Dataform.aspx', null, 'height=700,width=760,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );", true);
                    //string hash = "";
                    //hash += "BRAMHACORL" + "|";
                    ...
                    var oid = new String(stringChars);

                    SqlCommand cmd2 = new SqlCommand("select top(1) id from customersteps where orderid=@orderid ", con);
                    ...
                    {
                        SqlCommand cmd345 = new SqlCommand("update customersteps set orderid=@orderid where stepid=@stepid", con);
                        cmd345.Parameters.AddWithValue("@orderid", oid);
                        cmd345.Parameters.AddWithValue("@stepid", Session["stepid"].ToString());
                        cmd345.ExecuteNonQuery();
                    ...
                    string Bname = Session["billingname"].ToString();
                    string Bemail = Session["billingemail"].ToString();
                    string Bphone = Session["billingphone"].ToString();
                    string orderid = oid;
                    timerbooking.Enabled = true;
                    //RegisterStartupScript(Page, typeof(Page), "Open", "window.open('Dataform.aspx?BillingName='+ Bname);", true);


                    //Response.Redirect("Dataform.aspx?BillingName=" + Bname + "&orderid=" + orderid + "&Address=" + txtbuilding.Text + ',' + txtarea.Text + "&city=" + txtcity.Text + "&email=" + Bemail + "&phone=" + Bphone + "&state=" + txtstate.Text + "&zip=" + txtpincode.Text, false);
                    //Response.Write("<script>window.open ('Dataform.aspx?BillingName=" + Bname + "&orderid=" + orderid + "&Address=" + txtbuilding.Text + ',' + txtarea.Text + "&city=" + txtcity.Text + "&email=" + Bemail + "&phone=" + Bphone + "&state=" + txtstate.Text + "&zip=" + txtpincode.Text+"','_blank');</script>");
                    ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow", "var Mleft = (screen.width/2)-(760/2);var Mtop = (screen.height/2)-(700/2);window.open( 'Dataform.aspx?BillingName=" + Bname + "&orderid=" + orderid + "&Address=" + txtbuilding.Text + ',' + txtarea.Text + "&city=" + txtcity.Text + "&email=" + Bemail + "&phone=" + Bphone + "&state=" + txtstate.Text + "&zip=" + txtpincode.Text + "', null, 'height=700,width=760,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );", true);
        ...
        protected void btnlocation_Clicked(object sender, EventArgs e)
        {
            ...
            //ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrolltopevent", " $('html, body').animate({ scrollTop: $(\"body\").offset().top }, 500);", true);
            buyer.Attributes["Style"] = "background-color:#b01b2a !important;";
            textcolor1.Attributes["Style"] = "color:#ffff !important;";
        ...
        protected void btnother_Clicked(object sender, EventArgs e)
        {
            if (txtbuilding.Text != "" && txtarea.Text != "" && txtpincode.Text.Length == 6 && txtpincode1.Text.Length == 6 && txtpincode.Text != "" && txtbuilding1.Text != "" && txtarea1.Text != "" && txtcity1.Text != "" && txtcity.Text != "" && txtstate.Text != "" && txtstate1.Text != "" && txtpincode1.Text != "")
            {
                ...
                try
                {
                    ...
                    communiinfo.Attributes["Style"] = "background-color:#b01b2a !important";
                    textcolor2.Attributes["Style"] = "color:#ffff !important;";
                    //buyer.Attributes["Style"] = "background-color:#b01b2a !important;";
                    //textcolor1.Attributes["Style"] = "color:#ffff !important;";
                }
        ...
        protected void lnkconti_Click(object sender, EventArgs e)
        {
            ...
            if (txtbuilding.Text != "" && txtarea.Text != "" && txtpincode.Text.Length == 6 && txtpincode1.Text.Length == 6 && txtpincode.Text != "" && txtbuilding1.Text != "" && txtarea1.Text != "" && txtcity1.Text != "" && txtcity.Text != "" && txtstate.Text != "" && txtstate1.Text != "" && txtpincode1.Text != "" && (rdenduse.Checked || rdinvestment.Checked) && (rdyes.Checked || rdno.Checked) && ((rdhoarding.Checked || rdemail.Checked || rdweb.Checked || rdacq.Checked || rdother.Checked) || (rdbroker.Checked && txtadvspecify.Text != "")) && (rdmobile.Checked || rdtele.Checked || rdltr.Checked || rdemails.Checked))
            {
                try
                {
                    ...
                    step44.Attributes["Style"] = "background-color:#b01b2a; !important;";
                    steptext4.Attributes["Style"] = "color:#fff !important;";
                    steptextfour.Attributes["Style"] = "color:#fff !important;";
                    step444.Attributes["Style"] = "background-color:#b01b2a; !important;";
                    // steptext444.Attributes["Style"] = "color:#fff !important;";
                    steptext44.Attributes["Style"] = "color:#fff !important;";
                    pnlunit.Visible = false;
                    pnlcostsheet.Visible = false;
                    pnlbookingform.Visible = false;
                    pnlpay.Visible = false;
                    ...
                    Otherinfo.Attributes["Style"] = "background-color:#b01b2a !important;";
                    textcolor3.Attributes["Style"] = "color:#ffff !important;";
        ...
        {
            if (ddunit.SelectedValue == "1" || ddunit.SelectedValue == "2")
            {
                LinkButton lnkconfigselect = new LinkButton();
                LinkButton lnkcardclick = (LinkButton)sender;
                lnkconfigselect.CommandArgument = lnkcardclick.CommandArgument;
                ...
                displayblock(towerid);
            }
            else if (ddunit.SelectedValue == "0")
            {
                LinkButton lnkconfigselectone = new LinkButton();
                LinkButton lnkcardclick = (LinkButton)sender;
                lnkconfigselectone.CommandArgument = lnkcardclick.CommandArgument;
                //string[] strtowerid = lnkcardclick.CommandArgument.ToString().Split('_');
                //string towername = strtowerid[0];
                //SqlCommand cmd333 = new SqlCommand("select id from PropertyListTower where towername="+ towername + "", con);
                //SqlDataAdapter da333 = new SqlDataAdapter(cmd333);
                //DataTable dt333 = new DataTable();
                //da333.Fill(dt333);
                //string towerid = dt333.Rows[0]["id"].ToString();
                string[] strtowerid = lnkcardclick.CommandArgument.ToString().Split('_');
                string towerid = strtowerid[0];
                displayblock(towerid);
            }
        ...
        protected void btn3click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddunitvalue.SelectedValue != "0")
                {
                    ...
                    if (ddunit.SelectedValue == "1")
                    {
                        svgfilter = "pnls" + lnkcardclick.CommandArgument + "g";

                        string[] strArray = new string[] { "pnlsA2g", "pnlsA3g", "pnlsA5g", "pnlsA6g",  "pnlsA8g", "pnlsA9g", "pnlsA10g", "pnlsA11g", "pnlsA12g",
                                                           "pnlsA13g", "pnlsA14g","pnlsA15g", "pnlsB3g","pnlsB2g", "pnlsB4g","pnlsB5g", "pnlsB7g","pnlsB8g", "pnlsC4g",
                                                                  "pnlsC6g", "pnlsC8g", "pnlsC9g", "pnlsC11g", "pnlsC12g", "pnlsD9g", "pnlsD10g", "pnlsE9g",
                                                                   "pnlsE12g", "pnlsE10g", "pnlsF10g" };

                        for (int i = 0; i < strArray.Length; i++)
                        {
                            //strArray[i].Visible = false;

                            var control = FindControl(strArray[i]);
                            if (control != null)
                                control.Visible = false;
                        ...
                        var findex = Array.IndexOf(strArray, svgfilter);
                        var control1 = FindControl(strArray[findex]);
                        if (control1 != null)
                            control1.Visible = true;
                        lblmsg.Visible = false;
                        Session["visiblesvg"] = control1.ClientID;
                        pnlsShed.Visible = false;
                        pnlrRcc.Visible = false;
                    ...
                    {
                        svgfilter = "pnlr" + lnkcardclick.CommandArgument + "g";
                        string[] strArray = new string[] { "pnlrA1g", "pnlrB1s", "pnlrA7f", "pnlrA7s", "pnlrA7g", "pnlrB1g", "pnlrC5g", "pnlrC7g", "pnlrC7f", "pnlrC7s", "pnlrC10g",
                                                           "pnlrD6g", "pnlrD5g", "pnlrD5f", "pnlrD5s", "pnlrD7g", "pnlrD7f", "pnlrD7s", "pnlrD8g", "pnlrD8f", "pnlrD8s", "pnlrE5g",
                                                           "pnlrE5f", "pnlrE5s", "pnlrE6g","pnlrE6f", "pnlrE6s", "pnlrE7g", "pnlrE7f", "pnlrE7s", "pnlrE8g", "pnlrE8f", "pnlrE8s",
                                                           "pnlrF4g", "pnlrF4f", "pnlrF6g", "pnlrF6f", "pnlrF6s", "pnlrF8g", "pnlrF8f", "pnlrF8s"};
                    ...
                    else if (ddunit.SelectedValue == "0")
                    {
                        ...
                        lnkconfigselectone.CommandArgument = lnkcardclick.CommandArgument;
                        string[] strtowerid = lnkcardclick.CommandArgument.ToString().Split('_');
                        string svgid = strtowerid[1];
                        string svgname = strtowerid[0];
                        Session["svgname"] = svgname;
                        svgfilter = svgid;

                        string[] strArray = new string[] { "pnlrA1g", "pnlrB1s", "pnlrA7f", "pnlrA7s", "pnlrA7g", "pnlrB1g", "pnlrC5g", "pnlrC7g", "pnlrC7f", "pnlrC7s", "pnlrC10g", "pnlrD6g", "pnlrD5g", "pnlrD5f", "pnlrD5s", "pnlrD7g", "pnlrD7f", "pnlrD7s", "pnlrD8g", "pnlrD8f", "pnlrD8s", "pnlrE5g", "pnlrE5f", "pnlrE5s", "pnlrE6g",
                                                           "pnlrE6f","pnlrE6s", "pnlrE7g", "pnlrE7f", "pnlrE7s", "pnlrE8g", "pnlrE8f", "pnlrE8s", "pnlrF4g", "pnlrF4f", "pnlrF6g", "pnlrF6f", "pnlrF6s", "pnlrF8g", "pnlrF8f", "pnlrF8s" ,"pnlrA1g", "pnlrB1s", "pnlrA7f", "pnlrA7s", "pnlrA7g", "pnlrB1g", "pnlrC5g", "pnlrC7g", "pnlrC7f", "pnlrC7s",
                                                           "pnlrC10g", "pnlrD6g", "pnlrD5g", "pnlrD5f", "pnlrD5s", "pnlrD7g", "pnlrD7f", "pnlrD7s", "pnlrD8g", "pnlrD8f", "pnlrD8s", "pnlrE5g", "pnlrE5f", "pnlrE5s", "pnlrE6g",
                                                           "pnlrE6f","pnlrE6s", "pnlrE7g", "pnlrE7f", "pnlrE7s", "pnlrE8g", "pnlrE8f", "pnlrE8s", "pnlrF4g", "pnlrF4f", "pnlrF6g", "pnlrF6f", "pnlrF6s", "pnlrF8g", "pnlrF8f", "pnlrF8s","pnlsA11g"};
        ...
        protected void btnContinue_Clicked(object sender, EventArgs e)
        {
            ...
            //btn1click(sender, e);
            // string svgopen= Session["visiblesvg"].ToString();
            // string idnumber="";
            //SqlCommand cmd345 = new SqlCommand(" select id from PropertyListTower where towername = "+ svgopen + "", con);
            // cmd345.Parameters.AddWithValue("@id", idnumber.ToString());
        ...
        protected void btnPrevious_Clicked(object sender, EventArgs e)
        {
            ...
            var control = FindControl(svg);
            control.Visible = false;
            string svgopen = Session["svg"].ToString();
            var controlsvg = FindControl(svgopen);
            controlsvg.Visible = true;
            lblmsg.Visible = false;
