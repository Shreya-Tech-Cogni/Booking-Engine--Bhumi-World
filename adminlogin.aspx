<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="bramhacorp.adminlogin" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="icon" sizes="48x48 32x32 16x16" href="images/favicon.png"> 
...
<body style="background: #3e3e40;">
    <div class="smallloading" style="z-index: 4; position: absolute; background-image: url('images/Login/desktop.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center center; overflow: hidden; right: 0%; bottom: 0%; width: 100.00%; height: 100.00%">
    </div>
    <div id="preloader">
                        ...
                        <form class="registration-form">
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:Panel runat="server" ID="pnllogin">
                                        <label id="Label4" runat="server" style="margin-top: 20px">
                                            <span class="material-icons-outlined" style="display: inline-block; margin-right: 5px; font-size: 20px; color: #c5c5c5 !important; -webkit-text-stroke: 0.5px white; vertical-align: sub;">email</span>
                                            <asp:TextBox class="input" placeholder="Enter Email ID"   Style="display: inline-block; font-size: 13px; color: #9b95b8 !important; font-weight: 400; line-height: 20px;"
                                    ...
                                    <asp:Panel Visible="false" runat="server" ID="pnlotp">
                                        ...
                                        <label id="Label3" runat="server" style="margin-top: 20px">
                                           ...
                                           <label id="Label7" runat="server" style="margin-top: 20px">
                                            <span class="material-icons-outlined" style="display: inline-block; margin-right: 5px; font-size: 20px; color: #c5c5c5 !important; -webkit-text-stroke: 0.5px white; vertical-align: sub;">lock</span>
                            ...
                            <div class="text-center">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Button ID="btnlogin" Style="width: 300px; background: #43a4f1; color: white; border: none; line-height: 26px; cursor: pointer; margin-top: 10px; text-transform: uppercase; border-radius: 5px; font-weight: 600; font-size: 15px;"
                                            class="submit" runat="server"
                                            OnClick="btnlogin_Click" Text="Login" />
                                     <%--   <asp:Button ID="btnregister" Style="width: 300px; background: #43a4f1; color: white; border: none; line-height: 26px; cursor: pointer; margin-top: 10px; text-transform: uppercase; border-radius: 5px; font-weight: 600; font-size: 15px;"
                                            class="submit" runat="server"
                                            OnClick="Register_Click" Text="Continue" />
                                        <asp:Button ID="Button1" Visible="false" Style="width: 300px; background: #43a4f1; color: white; border: none; line-height: 26px; cursor: pointer; margin-top: 10px; text-transform: uppercase; border-radius: 5px; font-weight: 600; font-size: 15px;"
                                      ...
                                      <%--  <div style="margin-top: 8px;">
                                            <asp:LinkButton ID="lnkforget" Style="color: #43a4f1 !important;" runat="server"
                                                OnClick="lnkforget_Click" CommandArgument="0"> Forget Password? </asp:LinkButton>
                                        </div>
                                        <div style="margin-top: 8px;">
                                            <asp:LinkButton ID="lnklogin" Style="color: #43a4f1 !important;" runat="server" OnClick="lnklogin_Click"
